export class Remiseria {
  ...
  capacidadTotalYendoA(velocidad) {
    ...
    var lista = this.velocidadMaximaMayorOIgual(velocidad)
  ...
  colorDelAutoMasRapido() {
    const autoMasRapido = this.vehiculos.reduce((autoPrevio, autoSiguiente) => (autoPrevio.velocidadMaxima() > autoSiguiente.velocidadMaxima()) ? autoPrevio : autoSiguiente)
